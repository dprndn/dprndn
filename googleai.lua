...
CloseBtn.BackgroundColor3 = Color3.fromRGB(0, 120, 255) -- Confirming changes
...
Status.Text = "P: Add | F: Run Once | X: Nuke"
...
-- Teleport Sequence (Runs ONLY once per F press)
...
CloseBtn.MouseButton1Click:Connect(nuke)
